 ...
 */
public class BDeuScore3 implements LocalDiscreteScore, GesScore {
     ...
     */
    private int[] findIntersection1(int[] l1, int[] l2) {
        int i = 0;
        int j = 0;
        ...
        public VariableBox2(DiscreteVariable var1, DiscreteVariable var2, int[] data1, int[] data2) {
            ...
            for (int d1 = 0; d1 < numCategories1; d1++) {
                for (int d2 = 0; d2 < numCategories2; d2++) {
                    ...
                    int[] interList = new int[bounds[d1][d2] + 1];
                    System.arraycopy(list, 0, interList, 0, bounds[d1][d2] + 1);
