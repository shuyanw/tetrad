 ...
 */
public final class IndTestSemScore implements IndependenceTest {
...
//    private final TetradMatrix _covMatrix;
     ...
     */
    public IndTestSemScore(DataSet dataSet, double alpha) {
     ...
     */
    public IndTestSemScore(TetradMatrix data, List<Node> variables, double alpha) {
     ...
     */
    public IndTestSemScore(ICovarianceMatrix covMatrix, double alpha) {
    ...
    public IndependenceTest indTestSubset(List<Node> vars) {
        ...
        return new IndTestSemScore(newCovMatrix, alphaNew);
    }
    ...
    public boolean isIndependent(Node x, Node y, List<Node> z) {
        ...
        double bump = score.localScoreDiff(variables.indexOf(y), getIndices(z), variables.indexOf(x));

        boolean independent = bump < 0;
    ...
    private int[] getIndices(List<Node> z) {
