...
//
//        if (algorithm == FindTwoFactorClusters.Algorithm.SAG) {
//            allClusters = estimateClustersSAG();
//        } else if (algorithm == FindTwoFactorClusters.Algorithm.GAP) {
...
//        if (zeroCorr(pentad, 4)) return false;
//
...
//    }
//
//    // Finds clusters of size 6 or higher for the SAG algorithm.
...
//            }
//            if (_variables.size() < 5) break;
//
//            ChoiceGenerator gen = new ChoiceGenerator(_variables.size(), 5);
//            int[] choice;
//
//            while ((choice = gen.next()) != null) {
...
//
//                List<Integer> cluster = pentad(n1, n2, n3, n4, n5);
//
//                // Note that purity needs to be assessed with respect to all of the variables in order to
//                // remove all latent-measure impurities between pairs of latents.
...
//
//                List<Integer> sextad = quartet(t1, t2, t3, t4);
//                sextad.add(o);
//
...
//
//            double logsum = test.getLogProductCorrelations();
//            logsum += Math.log(p);
//
//            System.out.println(logsum);
//
//            if (logsum < 1) return false;
//
...
//
////        for (int i = 0; i < 10; i++) {
////            if (test.getPValue(independents) < alpha) {
////                return false;
////            }
////        }
//
