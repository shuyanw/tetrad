...
//
                            ...
                            double bump = gesScore.localScoreDiff(child, new int[]{}, parent, null);
...
//    }
    ...
    private double scoreGraphChange(Node y, Set<Node> parents,
        ...
        return gesScore.localScoreDiff(yIndex, parentIndices, hashIndices.get(x), null);
    }
