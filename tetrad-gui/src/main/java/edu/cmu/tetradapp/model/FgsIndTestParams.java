 ...
 */
public class FgsIndTestParams implements IndTestParams {
     ...
     */
    private FgsParams originalParams;
    ...
    public FgsIndTestParams(FgsParams originalParams) {
     ...
     */
    public static FgsIndTestParams serializableInstance() {
        return new FgsIndTestParams(FgsParams.serializableInstance());
    }
