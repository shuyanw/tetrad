...
public class FgsRunner2 extends AbstractAlgorithmRunner implements GraphSource,
...
//    private List<Map<Graph, Double>> allDagsToScores;
    ...
    public FgsRunner2(GraphWrapper graphWrapper, FgsParams params) {
        super(graphWrapper.getGraph(), params, null);
    }

    public FgsRunner2(DataWrapper dataWrapper, FgsParams params) {
        super(dataWrapper, params, null);
    }

    public FgsRunner2(DataWrapper dataWrapper, GraphSource trueGraph, FgsParams params) {
        this(dataWrapper, params, null);
        this.initialGraph = trueGraph.getGraph();
    }

    public FgsRunner2(DataWrapper dataWrapper, FgsParams params, KnowledgeBoxModel knowledgeBoxModel) {
     ...
     */
    public FgsRunner2(GraphSource graphWrapper, PcSearchParams params, KnowledgeBoxModel knowledgeBoxModel) {
    ...
    public static FgsRunner2 serializableInstance() {
        return new FgsRunner2(DataWrapper.serializableInstance(),
